...
<html lang="en">
  ...
  <head>
    ...
    <!-- title -->
    <title>3.7.2-My-Download-Notes</title>
<!-- Favicon -->
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="#"><img
                      src="images/Dashboard/eye.png"
                      class="edit-action" alt="edit-icon"
                      /></a>
                  <div class="dropdown my-download">
                    ...
                    <div class="dropdown-content">
                      ...
                      <a href="#">Add Reviews/Feedback</a>
                      <a href="#">Report as inapproprite</a>
                    </div>
                  </div>
                </td>
              </tr>

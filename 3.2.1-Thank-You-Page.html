...
<head>
    ...
    <!-- title -->
    <title>3.2.1-Thank-You-Page</title>
<!-- Favicon -->
...
<body>
    ...
    <div id="popup-modal">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#thank-you-modal">
            Thankyou pop modal
        </button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="detail">
                            <h3>Dear Smith,</h3>
                            <p>As this is paid notes - you need to pay to seller Rahil Shash offilne. We will send him an email that you want to download this note. he may contact you further for payment process completion. </p>

                ...
                <div class="row dashboard-1">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                        <div class="add-note-btn">
                            <a href=""><button>add note</button></a>
                        </div>
                    </div>
                </div>
                <div class="dashboard-detail-2">
                    <div class="flex-container-2">
                        <div style="flex-grow: 5" id="dash-4"><div
                                class="dash-user-1">
                                <!-- <h6>My Earning</h6> -->
                                <img src="images/Dashboard/dashboard.png"
                                    id="img-4" alt=""><br>
                                <span id="earning">My Earning</span></div>
                        </div>
                        <div style="flex-grow: 6" id="box-2"><div
                                class="dash-user-1"><h6>100</h6><span>Number
                                    of Notes Sold</span></div></div>
                        <div style="flex-grow: 6" id="box-3"><div
                                class="dash-user-1"><h6>$10,00,000</h6><span>Money
                                    Earned</span></div></div>
                        <div style="flex-grow: 4"><div class="dash-user-1"><h6>38</h6><span>My
                                    Downloads</span></div></div>
                        <div style="flex-grow: 4"><div class="dash-user-1"><h6>12</h6><span>My
                                    Rejected
                                    Notes</span></div></div>
                        <div style="flex-grow: 4" id="dash-3"><div
                                class="dash-user-1"><h6>102</h6><span>Buyer
                        ...
                        <div class="col-md-6 text-right">
                            <div class="progress-note-btn">
                                <input type="text" id="search-enter-progress"
                                    ...
                                    in a name"> <a href=""><button>Search</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Science</td>
                                <td>Draft</td>
                                <td><img src="images/Dashboard/edit.png"
                                        class="action-1" alt=""><img
                                        src="images/Dashboard/delete-2.png"
                                        alt=""></td>
                            </tr>
                            <tr>
                                ...
                                <td>Commerce</td>
                                <td>In Review</td>
                                <td><img src="images/Dashboard/eye.png" alt=""></td>
                            </tr>
                            <tr>
